							...
							<div class="single-post-details-area">
								<div class="post-content">
									<article class="question">
										...
										<br>
										<br>
										<br> <input id="type" type="hidden" value="EI">
										<!-- 어떤 타입을 물어보는 문제인지 알기위해 사용 -->

										<!-- 질문 답버튼 -->
										<div id="resultBtn1">
											<button id="a" type="button"
												class="btn alazea-btn-orange ml-15">a대답</button>
											<br>
											<button id="b" type="button"
												class="btn alazea-btn-orange ml-15">b대답</button>
											<br>
											<button id="c" type="button"
												class="btn alazea-btn-orange ml-15">c대답</button>
										</div>


										<div id="resultBtn">
											<button id="A" type="button"
												class="btn alazea-btn-orange ml-15 mbtiResultBtn" >ESTJ대답</button>
											<br><br>
											<!-- 위의 것은 E, S, T, J 값 -->
											<button id="B" type="button"
												class="btn alazea-btn-orange ml-15 mbtiResultBtn">INFP대답</button>
											<!-- 아래는 I, N, F, P 값 -->
										</div>
				...
				<div class="row justify-content-center">
					...
					<div class="col-12 col-md-8">
						<div class="blog-posts-area">
							...
							<div class="single-post-details-area">
								<div class="post-content">
									<h4 class="post-title">당신의 <br> <strong>레벨을 보니</strong></h4>

									<div class="post-thumbnail mb-30">
										<img src="resources/img/icon/돋보기.png" width="30px" height="30px">
									</div>
									<div style="display: flex;">&nbsp;&nbsp;●<p id="lvTitle"></p></div>	
									<p id="lvExplain"></p>
									...
									<h4 class="post-title">키우는 <br><strong>공간을 분석해보니</strong> </h4>
									...
									<h4 class="post-title">당신의 공간에<br> <strong>추천하는 식물은</strong></h4>

									<!-- ##### Single Widget Area ##### -->
									<div class="single-widget-area" id="recommendPlant">
		...
		*/
		...
		function next() { //먼저 1번부터 시작
			...
			if(num == 8){
				...
				var enviNum = parseInt($("#ntmtht").val())+parseInt($("#nsmshs").val())+parseInt($("#nhmhhh").val())+parseInt($("#namaha").val());
				console.log(enviNum);
