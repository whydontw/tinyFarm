                            ...
                            <div class="container">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-12">
                                        ...
                                        <div class=" d-flex flex-wrap align-items-center justify-content-between">
                                            <div class="mb-50">
                                                <p><h5><b>🌱 답변 수정하기</b></h5></p>
                                            </div>
                                        </div>

                                        <!-- Contact Form Area -->
                                        <div class="contact-form-area mb-100">
                                            <form action="qnaAnswerUpdate.ad" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" id="contact-email" value="${qna.qnaAnswerCreatedate}" readonly="readonly">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
